...
export declare class NotifierNotificationComponent implements AfterViewInit {
     ...
     */
    onCustomAction(name: string, payload: any): void;
    /**
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NotifierNotificationComponent, "notifier-notification", never, { "notification": { "alias": "notification"; "required": false; }; }, { "ready": "ready"; "dismiss": "dismiss"; "customAction": "customAction"; }, never, never, false, never>;
}
